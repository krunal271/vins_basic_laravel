...
class PatientsDetailFormController extends Controller
{
    ...
    public function store(Request $request)
    {
         ...
         $patientId = $patientCreate->id;
            ...
            if($patientData) {
                $patientId = $patientData->id;
                 ...
                 return ['status' => '300','patientData'=>'', 'message' => 'Record not found'];
            }
        ...
        if ($ipdData) {
            return ['status' => '200','data'=>['patientId'=> $patientId,'ipdId' => $ipdData->id], 'message' => 'Record Sucessfully created'];
        } else {
            return ['status' => '300','data'=>'', 'message' => 'Something goes wrong'];
        }
        // return view('\index');
    }
