...
$api->version('v1', function ($api) {
    ...
    // TODO: Move Method from web to api for Mobile App
        $api->post('/doctorsInitialAssessment', '\euro_hms\Api\Controllers\DoctorsInitialAssessmentController@store')->name('doctorInitialAssessment.store');
        $api->post('patient/create', '\euro_hms\Api\Controllers\PatientsDetailFormController@store')->name('patient.create');
        $api->post('adverseDrugReaction/create', '\euro_hms\Api\Controllers\AdverseDrugReactionController@store')->name('adverseDrugReaction.create');
         $api->post('appointmentBook/create', '\euro_hms\Api\Controllers\AppointmentBookController@store')->name('appointmentBook.create');
         $api->post('bloodSugarMonitoringChart/create', '\euro_hms\Api\Controllers\BloodSugarMonitoringChartController@store')->name('bloodSugarMonitoringChart.create');
         $api->post('bloodTransfusionDetails/create', '\euro_hms\Api\Controllers\BloodTransfusionFormController@store')->name('bloodTransfusionDetails.create');
         ...
         $api->post('completeNursingAssessment/create', '\euro_hms\Api\Controllers\completeNursingAssessmentController@store')->name('completeNursingAssessment.create');
         $api->post('cprFormat/create', '\euro_hms\Api\Controllers\CprFormatController@store')->name('cprFormat.create');
         $api->post('cultureBiopsyForm/create', '\euro_hms\Api\Controllers\CultureBiopsyFormController@store')->name('cultureBiopsyForm.create');
         ...
         $api->post('dischargeSummary/create', '\euro_hms\Api\Controllers\DischargeSummaryController@store')->name('dischargeSummary.create');
         $api->post('doctorsDailyNotes/create', '\euro_hms\Api\Controllers\DoctorsDailyNotesController@store')->name('doctorsDailyNotes.create');
         ...
         $api->post('NutritionalAssessmentForm/create','\euro_hms\Api\Controllers\NutritionalAssessmentFormController@store')->name('NutritionalAssessmentForm.create');
         $api->post('NutritionalScreeningForm/create','\euro_hms\Api\Controllers\NutritionalScreeningForControllerm@store')->name('NutritionalScreeningForm.create');
         $api->post('OperativeDetailSheet/create','\euro_hms\Api\Controllers\OperativeDetailSheetController@store')->name('OperativeDetailSheet.create');
         ...
         $api->post('PatientValuableForm/create','\euro_hms\Api\Controllers\PatientValuableFormController@store')->name('PatientValuableForm.create');
         ...
         $api->post('planOfCare/create', '\euro_hms\Api\Controllers\PlanOfCareController@store')->name('planOfCare.create');
         $api->post('preAnaesthesiaCheckupForm/create', '\euro_hms\Api\Controllers\PreAnaesthesiaCheckupFormController@store')->name('preAnaesthesiaCheckupForm.create');
         ...
         $api->post('provisionalDischargeSummary/create', '\euro_hms\Api\Controllers\ProvisionalDischargeSummaryController@store')->name('provisionalDischargeSummary.create');
         ...
         $api->post('doctorsHandover/create', '\euro_hms\Api\Controllers\doctorsHandoverController@store')->name('doctorsHandover.create');
         ...
         $api->post('infusionTherapyChart/create', '\euro_hms\Api\Controllers\infusionTherapyChartController@store')->name('infusionTherapyChart.create');
         $api->post('erObservation/create', '\euro_hms\Api\Controllers\erObservationController@store')->name('erObservation.create');
         $api->post('gatePass/create', '\euro_hms\Api\Controllers\gatePassController@store')->name('gatePass.create');
         $api->post('historyForm/create', '\euro_hms\Api\Controllers\historyFormController@store')->name('historyForm.create');
         ...
         $api->post('MARFlowSheet/create', '\euro_hms\Api\Controllers\FormsOptionsDataController@storel')->name('MARFlowSheet.create');
