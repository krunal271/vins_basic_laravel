...
import Doctor_initial_assessment from './views/admin/vins/doctorInitialAssessment.vue'
...
import testFile from './views/admin/vins/testFile.vue'
...
const routes = [
...

    {
        ...
        children: [
            ...
            {
                path: '/doctor_initial_assessment',
                component: Doctor_initial_assessment,
                name: 'doctor_initial_assessment'
            },
            {
            ...
            {
                path: '/infusion_therapy_chart',
                component: infusionTherapyChart,
                name: 'infusion_therapy_chart'
            },
            {
            ...
            {
                path: '/intraoperative_event_management',
                component: intraoperativeEventManagement,
                name: 'intraoperative_event_management'
            },
            {
                path: '/mar_flowsheet',
