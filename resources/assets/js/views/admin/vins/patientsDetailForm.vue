		...
		<form method = "post">
			...
			<div class="row form-group">
				<div class="col-md-6">
					...
					<div class="col-md-6">
						<input class="form-control" type="date" id="date" name="date" value="" v-model="patientData.p_date">
					</div>
				</div>
				<div class="col-md-6">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<input class="form-control" type="time" name="time" id="time" value="" v-model="patientData.p_time"/>
			...
			<div class="row form-group">
				<div class="col-md-6">
			      ...
			      <label class="control-label" for="phone_no">Phone no.: </label>
					...
					<div class="col-md-6">
				      	<input class="form-control" type="text" id="phone_no" name="phone_no" value="" v-model="patientData.ph_no"/>
				...
				<div class="col-md-6">
			      ...
			      <label class="control-label" for="mobile_no">Mobile no.: </label>
					...
					<div class="col-md-6">
			      	<input class="form-control" type="text" id="mobile_no" name="mobile_no" value="" v-model="patientData.mob_no" v-validate="'required'"/>
			      		<span class="help is-danger" v-show="errors.has('mobile_no')">
		                	Field is required
		                </span>
					</div>
				</div>
	            	...
	            	if (!this.errors.any()) {
		                ...
		                (response) => {
		                	if(response.data.code == 200) {
		                		...
		                		this.$store.dispatch('SetPatientId',response.data.data.patientId);
		                		this.$store.dispatch('SetIpdId',response.data.data.ipdId);
