			...
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<th>Site</th>
						<td><input class="form-control" type="checkbox" name="procedure" v-model="surgicalSafetyChecklistData.procedure" value="yes"/></td>
						<th>Procedure</th>
					</tr>
					<tr>
		            ...
		            <option>7ML/kg in children</option>
		            <option>Yes, and adequate interevenous access and fluids planned</option>
		            <option>Blood component Therapy Need anticipated</option>
		            <option>Yes and components are ready/available</option>
		            <option>No.</option>
		          </select>
						</td>
					</tr>
