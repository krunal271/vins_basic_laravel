  ...
  <div class="container">
	...
	<div class="row">
		<div class="col-md-4 top-buffer">
			<a class="btn btn-default btn-block text-center" style="white-space: normal;" @click="GetSelectComponent('doctor_initial_assessment')">Doctors Initial Assessment</a>
		</div>
		<div class="col-md-4 top-buffer">
		...
		<!-- <div class="col-md-4 top-buffer">
      <a class="btn btn-default btn-block text-center" style="white-space: normal;" @click="GetSelectComponent('testFile')">TestFile</a>
		</div> -->
		<div class="col-md-4 top-buffer">
	...
	<div class="row">
      ...
      <div class="col-md-4 top-buffer">
		...
		<div class="row">
			<div class="col-md-4 top-buffer">
				<a class="btn btn-default btn-block text-center" style="white-space: normal;" href="#" @click="GetSelectComponent('surgicalSafetyChecklist')" > Surgical Safety Checklist </a>
			</div>
			<div class="col-md-4 top-buffer">
		...
		<div class="row">
			<div class="col-md-4 top-buffer">
				<a class="btn btn-default btn-block text-center" style="white-space: normal;" href="#" @click = "GetSelectComponent('post_anaesthesia_evaluation')"> Post Anesthesia Evaluation </a>
			</div>
			<div class="col-md-4 top-buffer">
				<a class="btn btn-default btn-block text-center" style="white-space: normal;" href="#" @click = "GetSelectComponent('intraoperative_event_management')" > Intra Operative Event & Management</a>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-4 top-buffer">
				<a class="btn btn-default btn-block text-center" style="white-space: normal;"  @click="GetSelectComponent('infusion_therapy_chart')" >Infusion Therapy Chart</a>
			</div>
			<div class="col-md-4 top-buffer">
		...
		<div class="row">
			<div class="col-md-4 top-buffer">
				<a class="btn btn-default btn-block text-center" style="white-space: normal;" href="#" @click="GetSelectComponent('RestraintAdministration')"> Restraint Administration </a>
			</div>
			<div class="col-md-4 top-buffer">
