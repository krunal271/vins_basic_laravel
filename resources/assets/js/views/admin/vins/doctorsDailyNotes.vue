  		...
  		<div class="row form-group">
            ...
            <span class="help is-danger" v-show="errors.has('name')">
  			...
  			<div class="col-md-4">
  				...
  				<div class="col-md-6">
  					<input class="form-control" id="ipd_no" type="text" name="ipd_no" v-model="doctorsDailyNotesData.ipd_no" v-validate="'required'" value="">
		    ...
		    saveDoctorsDailyNotes() {
	            ...
	            (response) => {
	            	if (!this.errors.any()) {
				    	...
				    	User.saveDoctorsDailyNotes(this.doctorsDailyNotesData).then(
		                (response) => {
