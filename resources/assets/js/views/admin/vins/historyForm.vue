	...
	<form action="" method="post">
		...
		<div class="row form-group">
			...
			<div class="col-md-4">
				...
				<div class="col-md-6">
					<input class="form-control ls-datepicker" type="text" id="date" name="date" value="" v-model="historyFormData.date" v-validate="'required'"/>
...
<script >
    ...
    export default {
        ...
        mounted() {
        	let vm =this;
	      	Plugin.initPlugins(['TimePickers','DatePicker'])
		    ...
		    savehistoryForm() {
	            ...
	            (response) => {
	            	if (!this.errors.any()) {
				    	...
				    	User.savehistoryForm(this.historyFormData).then(
		                (response) => {
