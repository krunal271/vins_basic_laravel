	...
	<div class="container">
		...
		<form action="" method="post">
			...
			<div class="row form-group">
				<div class="col">
					<div class=" form-check form-check-inline">
						<input  type="checkbox" class="" name="blood_pressure" v-model="NutritionalAssessmentForm.blood_pressure" v-validate="'required'" value=""/>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" class="" name="diabetes" v-model="NutritionalAssessmentForm.diabetes" v-validate="'required'" value=""/>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" class="t" name="old_operated_patient" v-model="NutritionalAssessmentForm.old_operated_patient" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('old_operated_patient')">
							Field is required
						</span>
			...
			<div class="row form-group">
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="cardiac_diseases" v-model="NutritionalAssessmentForm.cardiac_diseases" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('cardiac_diseases')">
							Field is required
						</span>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="liver_diseases" v-model="NutritionalAssessmentForm.liver_diseases" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('liver_diseases')">
							Field is required
						</span>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="renal_failure" v-model="NutritionalAssessmentForm.renal_failure" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('renal_failure')">
							Field is required
						</span>
			...
			<div class="row form-group">
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="cancer" v-model="NutritionalAssessmentForm.cancer" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('cancer')">
							Field is required
						</span>
						<label>Cancer</label>
					</div>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="trauma_burn" v-model="NutritionalAssessmentForm.trauma_burn" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('trauma_burn')">
							Field is required
						</span>
				...
				<div class="col">
					<div class="form-check form-check-inline">
						<input  type="checkbox" name="gout" v-model="NutritionalAssessmentForm.gout" v-validate="'required'" value=""/>
						<span class="help is-danger" v-show="errors.has('gout')">
							Field is required
						</span>
						<label>Gout</label>
					</div>
			...
			<div class="row form-group">
				...
				<div class="col-md-6">
					...
					<div class="col-md-6">
						<input class="form-control" type="text" name="risk_reason" v-model="NutritionalAssessmentForm.risk_reason" v-validate="'required'" placeholder="In case of Medium-High risk" value=""/>
						<span class="help is-danger" v-show="errors.has('risk_reason')">
							Field is required
						</span>
    ...
    export default {
        ...
        saveNutritionalAssessmentForm() {
	            ...
	            (response) => {
                    ...
                    User.saveNutritionalAssessmentForm(this.NutritionalAssessmentForm).then(
                         (response) => {
                         	console.log(response)
                         	if(response.data.status == 200) {
                         		toastr.success('x Assessment Form has been saved', 'Nutritional Assessment Form', {timeOut: 5000});
                         	}
