<div class="container">
  ...
  <form action="" method="post">
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="csf" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="ct_scan" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="mri" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="histopathology" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="electro_physiology" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="chest_xray" rows="3" class="form-control">  </textarea>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-6">
        <textarea name="others" rows="3" class="form-control">  </textarea>
