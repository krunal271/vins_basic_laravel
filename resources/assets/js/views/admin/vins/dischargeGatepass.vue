<template>
  <div class="container">
  	...
  	<form action="" method="post">
  		<div class="row form-group">
            ...
            <span class="help is-danger" v-show="errors.has('patients_name')">
  			...
  			<div class="col-md-6">
  				...
  				<div class="col-md-6">
  					<input class="form-control" name="room_details" v-model="dischargeGatepassData.room_details"  v-validate="'required'"/>
  		...
  		<div class="row">
  			<button class="btn btn-success" type="button" @click="saveDischargeGatepass()">Submit</button>
  		</div>
  	</form>
  </div>
</template>
