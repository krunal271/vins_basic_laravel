	...
	<div class="container">
		...
		<form action="" method="post">
			...
			<div class="row form-group">
				...
				<div class="col">
					<input class="form-control" type="text" name="uhid_no" v-model="PatientDietRecord.uhid_no" v-validate="'required'" value=""/>
    ...
    export default {
        ...
        savePatientDietRecord() {
	            ...
	            (response) => {
                   ...
                   User.savePatientDietRecord(this.PatientDietRecord).then(
                         (response) => {
